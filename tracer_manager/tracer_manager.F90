...
!#######################################################################
!
! <SUBROUTINE NAME="set_tracer_profile_r4" >
!   <OVERVIEW>
...
!   </DESCRIPTION>
!   <TEMPLATE>
!     call set_tracer_profile_r4(model, n, tracer)
!   </TEMPLATE>
...
subroutine set_tracer_profile_r4(model, n, tracer, err_msg)

integer,  intent(in)  :: model, n
   real(FLOAT_KIND), intent(inout), dimension(:,:,:) :: tracer
character(len=*), intent(out), optional :: err_msg

real(FLOAT_KIND)    :: surf_value, multiplier
integer :: numlevels, k, n1, flag
real(FLOAT_KIND)    :: top_value, bottom_value
...
end subroutine set_tracer_profile_r4
!</SUBROUTINE>

!
!#######################################################################
!
! <SUBROUTINE NAME="set_tracer_profile_r8" >
!   <OVERVIEW>
!     Subroutine to set the tracer field to the wanted profile.
!   </OVERVIEW>
!   <DESCRIPTION>
...
!   </DESCRIPTION>
!   <TEMPLATE>
!     call set_tracer_profile_r8(model, n, tracer)
!   </TEMPLATE>
...
!     Tracer number.
!   </IN>
!   <INOUT NAME="tracer_array" TYPE="double precision">
!     The initialized tracer array.
!   </INOUT>

subroutine set_tracer_profile_r8(model, n, tracer, err_msg)

integer,  intent(in)  :: model, n
   real(DOUBLE_KIND), intent(inout), dimension(:,:,:) :: tracer
character(len=*), intent(out), optional :: err_msg

real(DOUBLE_KIND) :: surf_value, multiplier
integer :: numlevels, k, n1, flag
real(DOUBLE_KIND) :: top_value, bottom_value
character(len=80) :: scheme, control,profile_type
character(len=128) :: err_msg_local
character(len=11) :: chn
...
end subroutine set_tracer_profile_r8
!</SUBROUTINE>
